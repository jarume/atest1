...
//	public SifSysRole findOne(Specification<SifSysRole> spec);
	 ...
	 * @return 查询到的实体对象集合
	 */
	public Specification<SifSysRole> getSpecificationbyname(final Role tmp);
	/**
	 * 该方法为不支持通过role_name来，模糊查询
	 * @param tmp
	 * @return
	 */
	...
	public List<SifSysRole> queryEntitiesByTemplatebyname(Role tmp);
}
